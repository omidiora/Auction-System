    ...
    <section class="featured-auction-section padding-bottom mt--240 mt-lg--440 pos-rel">
        <div class="container">
            <div class="section-header cl-white mw-100 left-style">
               ...
               @php
                  $jsonDecodeValue = json_decode($notification->data,true);  
               @endphp
               <div class="alert alert-primary" role="alert">
                <h4 class="alert-heading " style="color:black">Notification</h4>
                <p style="color:black;margin-top:2px">{{($jsonDecodeValue['line'])}}</p>
                <hr>
