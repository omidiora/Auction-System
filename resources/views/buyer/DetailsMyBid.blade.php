                ...
                <div class="col-lg-8">
                    <div class="product-details-content">
                        ...
                        <ul class="price-table mb-30">
                            ...
                            <li>
                                <span class="details">Your Bid</span>
                                <h5 class="info">#100000</h5>
                            </li>
                            <li>
                                <span class="details"> Current Highest Bidding Price</span>
                                <h5 class="info">#10000</h5>
                            </li>

                        </ul>
                        <div class="product-bid-area">
                            <div><strong> Wants to submit another bid?</strong> </div>
                ...
                <!-- <div class="tab-pane fade show" id="delevery">
                    <div class="shipping-wrapper">
                        ...
                        <div class="item">
                            ...
                            <p>Please carefully review our shipping and returns policy before committing to a bid. From time to time, and at its sole discretion, Sbidu may change the prevailing fee structure for shipping and handling.</p>
                        </div>
                    </div>
                </div> -->
