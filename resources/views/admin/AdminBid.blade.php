                ...
                <div class="row">
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner brand-color">
                                <h3>100</h3>

                                <p style="font-size: 1.2rem;">Total Number Of Users</p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner brand-color">
                                ...
                                <p style="font-size: 1.2rem;">Total Number Of Categories</p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner brand-color">
                                ...
                                <p style="font-size: 1.2rem;">Total Number Of Products</p>
                            </div>
                            <div class="icon">
            ...
            <div class="pb-3">
                <div class="card mt-3 ml-3 mr-3">
                    <div class="card-header brand-color">
                        <div class="row">
                            <div class="col-xs-12 col-sm-7 col-md-8 mb-3 result-head">
                                <h3 class="card-title">List Of Products Being Sold</h3>
                            </div>
                            <!-- <div class="col-xs-12 col-sm-5 col-md-4 result-head">
                                <div id="example1_filter" class="dataTables_filter">
                                    <label for=""><span class="search-txt"> Search: </span><input type="search"
                                    ...
                                    <table class="table table-head-fixed text-nowrap table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Accessory</td>
                                                <td>
                                                    <a href="../seller/product-details.html" class="btn btn-app">
                                                        <i class="fas fa-edit"></i> view details
                                                    </a>
                                                </td>
                                                <td>
