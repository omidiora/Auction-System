                ...
                <div class="card mt-3 ml-3 mr-3">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            <div class="row">
                                <div class="col-md-12">
                            {{-- action="{{route('UpdateAdminCategory', ['id' => $categories->id])}}"  --}}
                                    <form action="{{route("LanguageUpdate",['id' => $language->id])}}" method="post" >
                                        @csrf
                                        <div class="form-group">
                                            
                                            <input type="text" class="form-control" placeholder="Enter Language Name" name="name" value="{{$language->name}}">
                                        </div>

                                        <div class="form-group">
                                            <input type="submit" class="btn btn-outline-primary btn-add" name="submit" value="Update Language ">
                                        </div>
